...
Entry UI do cofre de senhas (URL `/e/apps/senhas`, qualquer autenticado): canais
privados por padrão + segredos cifrados em repouso. Layout `PageShell` com
sidebar de canais + painel de senhas.
...
Declaração canônica + criptografia no backend. Ver [../CLAUDE.md](../CLAUDE.md)
e `backend/extensions/apps/modules/senhas/`.

  ...
  return (
    <Dialog>
      ...
      <DialogContent className="sm:max-w-md">
        <FillDialogBody onFillFields={onFillFields} />
      </DialogContent>
    </Dialog>
  );
}

// Corpo montado só quando o Dialog abre (Radix monta o content na abertura):
// documentTypeId/file self-inicializam e resetam ao fechar, sem effect.
function FillDialogBody({ onFillFields }: Props): React.JSX.Element {
    ...
    <React.Fragment>
      <DialogHeader>
        ...
        <DialogDescription className="sr-only">
          Envie um documento e escolha o tipo para transcrever
        </DialogDescription>
      </DialogHeader>

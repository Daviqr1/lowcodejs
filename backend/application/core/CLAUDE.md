...
Sao 8 arquivos. Antes eram 42: os outros 35 viraram (ou foram absorvidos por)
...
| `validator.core.ts` | `features/_shared.validator.ts` (nivel global do padrao `_shared`) |

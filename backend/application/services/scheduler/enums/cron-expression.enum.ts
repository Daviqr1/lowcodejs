/**
 * Expressões cron prontas para uso. Réplica de `CronExpression` do
 * `@nestjs/schedule` (`base-cron/enums/cron-expression.enum.ts`), portada como
 * const object (estilo do projeto — code-pattern não usa `enum` TS).
 */
